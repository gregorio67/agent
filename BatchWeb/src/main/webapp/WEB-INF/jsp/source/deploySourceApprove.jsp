...
function fn_deployUpdate() {
	...
	if ($("#sourceDeploy #merge #approveStatus").prop('checked')) {
...
function fn_searchItemCallBack(result) {
	...
	if (result.sourceItem.approveStatus == 'Y') {
		$("#sourceDeploy #merge #approveStatus").prop("checked", true);
	}
	else {
		$("#sourceDeploy #merge #approveStatus").prop("checked", false);		
	}
		
	$("#sourceDeploy #merge #approveStatus").val(result.sourceItem.deployDescript);
						...
						<table class="list_table">
							...
							<tbody>
								<tr class="detail_view">
									...
									<td class="list_td align-left date">
										<input class="search_input" type="checkbox" id="approveStatus" maxlength="10"/>
									</td>
								</tr>
							</tbody>
						</table>
